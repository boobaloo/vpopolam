...
(function ($) {
    ...
    $.fn.prettyPhoto = function (pp_settings) {
        pp_settings = jQuery.extend({
            ...
            custom_markup: '',
            social_tools: '<div class="pp_social"><div class="twitter"></div><div class="facebook"></div><div class="vk"><div id="vk_likeButton"></div><script type="text/javascript" src="http://vk.com/js/api/share.js?11" charset="windows-1251"></script></div></div>', /* html or false to disable */
            twitter: true, /* Show twitter "follow" button */
            facebook: true, /* Show facebook "like" button */
            vk_id: false, /* "VK site ID" (my ID 2913600) to show vk.com "like" button or false to disable */
        }, pp_settings);
                ...
                switch (_getFileType(pp_images[set_position])) {
                    case 'image':
                        ...
                        imgPreloader.onerror = function () {
                            alert('Изображение не может быть загружено. Возможно оно было удалено или ошибка в адресе.');
                            $.prettyPhoto.close();
                        };
        ...
        */
        ...
        function _getCurrentPictureLink() {
            ...
            link = 'pp_' + theRel + '/' + rel_index + '/';
            var myLoc = window.location.href.split('#')[0];
            link = myLoc + "#" + link;
        ...
        */
        function _changeVk() {
            if (settings.vk_id) {
                ...
                description = "";
                $('#vk_likeButton').html('<script type="text/javascript" src="http://vk.com/js/api/share.js?11" charset="windows-1251"></script><script type="text/javascript">VK.init({apiId: ' + settings.vk_id + ', onlyWidgets: true});VK.Widgets.Like("vk_likeButton", {width: 100, pageTitle: "' + title + '", pageDescription: "' + description + '"});</script>');
            }
        };
        ...
        */
        function _changeFacebook() {
            if (settings.facebook) {
                var link = _getCurrentPictureLink();
                $('.pp_social .facebook').html('<iframe src="http://www.facebook.com/plugins/like.php&href=' + link + '&amp;layout=none&amp;show_faces=false&amp;width=450&amp;action=like&amp;font&amp;colorscheme=light&amp;height=23" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:24px;" allowTransparency="true"></iframe>');
            }
        };
